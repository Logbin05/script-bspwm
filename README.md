...
- glass-like `polybar` с рабочими столами, названием активного окна, звуком, Wi-Fi, Bluetooth, датой, треем и быстрыми действиями
...
- правый клик на модулях launcher/current-desktop/window/date/control открывает контекстное меню bar
